...
async function patchPanel(data){
  var id=getPanelId();
  if(!id) return;
  try{await api('/ticket-panels/'+id,'PATCH',data);toast('Sauvegarde !','success');}catch(e){toast('Erreur','error');}
}
